      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex items-center justify-center px-8 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
              <Link href={'https://dcodestechnologies.slack.com/archives/D09FSQ83WJZ/p1762233713947709'} className="group bg-white text-black px-12 py-4 text-sm tracking-wide uppercase hover:bg-gray-100 transition-all duration-500 relative overflow-hidden">
                <span className="relative z-10">Assess Your Needs</span>
              </Link>
              <button className="text-sm tracking-wide uppercase text-gray-400 hover:text-white transition-all duration-300 relative group">
                Explore Solutions
        ...
        <section className="py-32 px-8 border-t border-gray-900">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mb-12">
              <Link href={'https://calendly.com/sales-dcodestechnologies/30min'} className="bg-white text-black px-12 py-4 text-sm tracking-wide uppercase hover:bg-gray-100 transition-all duration-500 font-medium">
                Schedule Consultation
              </Link>
              <button className="border border-gray-800 px-12 py-4 text-sm tracking-wide uppercase hover:border-gray-600 transition-all duration-300 font-medium">
                Download ERP Transformation Guide
