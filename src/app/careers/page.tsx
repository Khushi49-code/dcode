...
export default function CareersPage() {
  ...
  //   // SIMPLE VALIDATION - Works with all emails
  ...
  //   // Simple email validation - accepts any email format
  ...
  //     console.log("Validation failed: Phone required");
  //     return;
  //   }
  ...
  //   if (!formData.resume) {
  //     setMessage("❌ Please upload your resume.");
  //     console.log("Validation failed: Resume required");
  //     return;
  //   }
  ...
  //     console.log("📤 Step 1: Uploading resume to Firebase Storage...");
  //     setUploadProgress(30);

  //     const fileName = `${Date.now()}_${formData.name.replace(/\s+/g, '_')}_${formData.resume.name}`;
  //     const storageRef = ref(storage, `jobApplications/resumes/${fileName}`);
  ...
  //         jobTitle: selectedJob?.title || formData.role,
  //         submittedAt: new Date().toISOString()
  //       }
  //     };

  //     setUploadProgress(50);
  //     const uploadSnapshot = await uploadBytes(storageRef, formData.resume, metadata);
  ...
  //     console.log("💾 Step 2: Saving application to Firestore...");
  ...
  //       // Job information
  //       role: formData.role.trim() || selectedJob?.title || "Not specified",
