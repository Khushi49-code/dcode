      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-20">
          ...
          <div className="border border-white/10 rounded-2xl p-12 bg-gray-900/20 backdrop-blur-sm">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <Link href="/careers" className="inline-flex items-center gap-3 px-6 py-3 border border-white/10 rounded-lg bg-gray-800/30 hover:border-blue-400 hover:bg-blue-400/10 transition-all duration-300 group">
        ...
        <section className="text-center py-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/careers" className="bg-blue-600 text-white px-8 py-4 rounded-full hover:bg-blue-700 transition-all duration-300 font-medium text-lg">
