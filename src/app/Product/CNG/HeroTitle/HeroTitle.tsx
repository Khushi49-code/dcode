...
const HeroTitle = () => {
    ...
    return (
        <div className="absolute inset-0 z-[5] flex flex-col items-center text-center justify-center px-4">
            {/* Main Title */}
            <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <h1 className="text-white text-center font-light tracking-tight drop-shadow-[0_0_20px_rgba(59,130,246,0.35)]
                    text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-[80px] leading-tight">
                    Optimizing CNG Kit Business with
                </h1>
            </div>

            {/* Subtitle */}
            <div className={`transition-all duration-1000 delay-500 mt-1 md:mt-2 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="flex flex-wrap items-baseline justify-center gap-x-2 gap-y-1">
                    <span className="text-blue-400 font-semibold tracking-tight
                        text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-[110px] leading-none">
                        Planning
                    </span>
                    <span className="text-white font-light tracking-tight drop-shadow-[0_0_20px_rgba(59,130,246,0.35)]
                        text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-[80px] leading-none">
                        Solutions
                    </span>
                </div>
            </div>
            ...
            <div className={`transition-all duration-1000 delay-700 mt-4 md:mt-6 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                {/* Tagline */}
                <p className="text-white/80 text-lg sm:text-xl md:text-2xl lg:text-3xl text-center max-w-4xl mx-auto mb-6 md:mb-8">
