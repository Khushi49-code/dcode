...
export default function Portfolio() {
  ...
  useEffect(() => {
    ...
    document.title = "Corporate Profile | Dcodes Technologies Portfolio | IT Solutions Company";
    ...
    metaDescription.setAttribute('content', "Explore Dcodes Technologies' corporate profile — web development, mobile apps, ERP systems, software development, digital marketing, and SEO services for global businesses.");
    ...
    metaKeywords.setAttribute('content', "Dcodes Technologies portfolio, IT services company profile, web development portfolio, software development company, digital marketing services, ERP solutions, mobile app development portfolio");
    ...
    ogTitle.setAttribute('content', "Corporate Profile | Dcodes Technologies Portfolio");
    ...
    ogDescription.setAttribute('content', "We offer professional and business IT solutions covering a large domain of sectors including web development, mobile apps, ERP, and digital marketing.");
    ...
    ogUrl.setAttribute('content', "https://dcodes.com/portfolio");
    ...
    ogImage.setAttribute('content', "https://dcodes.com/og-image-portfolio.jpg");
    ...
    twitterTitle.setAttribute('content', "Dcodes Technologies Corporate Profile");
    ...
    twitterDescription.setAttribute('content', "Professional IT solutions provider offering web development, mobile apps, ERP systems, and digital marketing services.");
    ...
    twitterImage.setAttribute('content', "https://dcodes.com/twitter-card-portfolio.jpg");
    ...
    canonical.setAttribute('href', "https://dcodes.com/portfolio");
    ...
    // Structured Data for Corporate Profile
    const structuredDataProfile = {
      "@context": "https://schema.org",
      "@type": "AboutPage",
      "name": "Dcodes Technologies Corporate Profile",
      "description": "Professional IT solutions provider offering comprehensive digital services",
      "url": "https://dcodes.com/portfolio",
      "about": {
        "@type": "Organization",
        "name": "Dcodes Technologies",
        "foundingDate": "2023",
        "foundingLocation": "India",
        "description": "Forward-thinking software development company dedicated to delivering innovative digital solutions",
        ...
        "itemListElement": [
          {
            ...
            "description": "Custom websites using WordPress, HTML, PHP, React, and e-commerce solutions"
          },
          {
            "@type": "Thing",
            "name": "Software Development",
            "description": "Custom software solutions for billing, tracking, and operations management"
          },
          {
            "@type": "Thing",
            "name": "Web ERPs",
            "description": "Custom ERP solutions and ready-to-use ERP products for business management"
          },
          {
            "@type": "Thing",
            "name": "Mobile App Development",
            "description": "Android, iOS, and cross-platform Flutter applications"
          },
          {
            "@type": "Thing",
    ...
    let scriptProfile = document.querySelector('#structured-data-profile');
    if (!scriptProfile) {
      scriptProfile = document.createElement('script');
      scriptProfile.id = 'structured-data-profile';
      scriptProfile.setAttribute('type', 'application/ld+json');
      document.head.appendChild(scriptProfile);
    }
    scriptProfile.textContent = JSON.stringify(structuredDataProfile);
    ...
    const structuredDataBreadcrumb = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Portfolio",
          "item": "https://dcodes.com/portfolio"
        }
      ]
    };
    ...
    const structuredDataServices = {
      "@context": "https://schema.org",
      "@type": "ItemList",
      "name": "IT Services Offered by Dcodes Technologies",
      ...
      "itemListElement": [
        {
          ...
          "position": 1,
          "name": "Web Development",
          "url": "https://dcodes.com/portfolio#web-development"
        },
        {
          "@type": "ListItem",
          "position": 2,
          "name": "Software Development",
          "url": "https://dcodes.com/portfolio#software-development"
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "ERP Solutions",
          "url": "https://dcodes.com/portfolio#erp-solutions"
        },
        {
          "@type": "ListItem",
          "position": 4,
          "name": "Mobile App Development",
          "url": "https://dcodes.com/portfolio#mobile-apps"
        },
        {
          "@type": "ListItem",
          "position": 5,
          "name": "Digital Marketing",
          "url": "https://dcodes.com/portfolio#digital-marketing"
        }
      ]
    };
    
    let scriptServices = document.querySelector('#structured-data-services');
    if (!scriptServices) {
      scriptServices = document.createElement('script');
      scriptServices.id = 'structured-data-services';
      scriptServices.setAttribute('type', 'application/ld+json');
      document.head.appendChild(scriptServices);
    }
    scriptServices.textContent = JSON.stringify(structuredDataServices);
  ...
  return (
    <div className="bg-black text-white mt-16 min-h-screen">
      <main className="max-w-6xl mx-auto px-6 py-16">
        ...
        {/* Website Development */}
        <section id="web-development" className="mb-32">
          <div className="mb-16">
        ...
        {/* Web ERPs - FIXED IMAGE SECTION */}
        <section id="erp-solutions" className="mb-32">
          <div className="mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="flex items-center justify-center">
              <div className="border border-white/10 rounded-lg p-8 w-full h-full flex items-center justify-center min-h-[300px] bg-white/5">
                <div className="text-center space-y-4">
                  {/* Fixed: Replaced missing image with beautiful SVG placeholder */}
                  <div className="flex justify-center">
                    <svg className="w-32 h-32 text-white/30" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M8 9l3 3-3 3" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M17 9l-3 3 3 3" />
                    </svg>
                  </div>
                  <p className="font-normal text-white/60 text-sm">ERP System Dashboard</p>
                  <p className="font-normal text-white/40 text-xs">Complete Business Management Solution</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Software Development */}
        <section id="software-development" className="mb-32">
          <div className="mb-16">
        ...
        <section id="digital-marketing" className="mb-32">
          <div className="mb-16">
        ...
        <section id="mobile-apps" className="mb-32">
          <div className="mb-16">
            ...
            <div className="space-y-12">
              <div className="text-center">
                ...
                <div className="space-y-2">
                  <a href="mailto:info@dcodestech.com" className="text-white/80 font-normal hover:text-white transition-colors">
                    info@dcodestech.com
                  </a>
                  <br />
                  <a href="tel:+916353653977" className="text-white/80 font-normal hover:text-white transition-colors">
                    +916 353 653 977
                  </a>
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <a href="https://www.dcodestech.com" className="text-white/80 font-normal hover:text-white transition-colors">
                  www.dcodestech.com
                </a>
              </div>
            </div>
